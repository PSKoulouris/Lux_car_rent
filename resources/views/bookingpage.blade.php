...
<x-nav-link-us>
    ...
    <form action="{{ route('bookingdetails') }}" method="post" class="mt-6  space-y-6">
        ...
        <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" type="date" min="5/16/2024" name="start-date" id="start-date"  required>
        </div>
        <div>
        <label class= 'block font-medium text-1xl text-gray-700' for="end-date">End date</label>
        <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" type="date" min="5/16/2024" name="end-date" id="end-date"  required>
        </div>
        <div>
