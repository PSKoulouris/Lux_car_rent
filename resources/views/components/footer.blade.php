...
<ul class="p-3">
                    <li> 
                        <a href="{{--{{route('terms')}}--}}" class="hover: text-white transition-all duration-500 ease-in-out"> Rental Agreement </a>
                    </li>
                    <li> 
...
<ul class= "p-3">
                    <li> 
                        <a href="{{route('contact')}}" class="hover: text-white transition-all duration-500 ease-in-out"> Contact us </a>
                    </li>
                    <li>
                        <a href="{{route('about')}}" class="hover: text-white transition transition-all duration-500 ease-in-out"> About us </a> 
                    </li>
            {{--<li> 
                 <a href="{{ (route('') }}" class="hover: text-gray-300 transition-all duration-500 ease-in-out"> Find us </a>
            </li> --}}
                    <li> 
                            <a href="{{route('welcome')}}" class="hover: text-white transition-all duration-500 ease-in-out"> Home </a>
                    </li>
            </ul>
