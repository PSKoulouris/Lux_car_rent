<footer class="text-gray-200 p-3 flex flex-col items-center" style="background-color: #2D3B4E;">
        <div class="container mx-auto px-6 flex justify-between"> 
<!--list1-->
            <ul class="p-3">
                    <li> 
                        <a href="{{--{{route('terms')}}--}}" class="hover: text-gray-300 transition-all duration-500 ease-in-out"> Rental Agreement </a>
                    </li>
                    <li> 
...
<!-- copyright LuxRent information-->
    <div class="flex justify-center p-4">
        <p class="text-xs text-gray-300">@2024 LuxRent. All rights reserved.</p>
    </div>
</footer>
