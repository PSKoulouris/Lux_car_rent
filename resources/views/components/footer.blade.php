<footer class=" p-4 bg-gray-900 text-gray-200">
    <div class="container mx-auto px6 flex justify-end"> 
        <ul class= "p-3">
            <li> 
...
//Icon list:
  ...
  {{--<path xmlns="http://www.w3.org/2000/svg" d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>--}}
                            </svg>
                            <span> Twitter</span>
            </li>
                <a href="#" class="flex items-center space-x-3 hover:text-sky-400 transition">
            <?xml version="1.0" encoding="utf-8"?>
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 28">
