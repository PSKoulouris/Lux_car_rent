...
<!-- creating a page to view booking details -->
    ...
    <div class="w-full bg-cyan-600 text-white flex items-center pl-2 font-bold text-1xl">
     ...
     <div class=" flex flex-col w-full bg-gray-100 mt-4">
        <p class="ml-4 mt-4">Customer name</p>
        <p class="ml-4 mt-4">Customer address</p>
        <p class="ml-4 mt-4">Customer email</p>
        <p class="ml-4 mt-4">Customer phoneNumber</p>
        <p class="ml-4 mt-4">Booking Days</p>
        <p class="ml-4 mt-4">Booking Amount</p>

        </div>
    <div>
        <form action="#">
            <button class="w-full border bg-gray-300 font-bold text-1xl rounded-xl p-2">Conform Booking</button>
        </form>
    </div>
