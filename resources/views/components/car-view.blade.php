...
<div class="w-[350px] h-[400px] flex flex-col justify-center items-center shadow-md bg-gray-400 mx-auto rounded-xl" >
    ...
    <div class="flex flex-col">
        ...
        <p class="bg-gray-200 w-[300px] font-bold text-center mt-1 rounded-lg">{{ $nameCar }}</p>
        <p class="bg-gray-200 w-[300px]font-bold text-center mt-1 rounded-lg">{{ $model }}</p>
        <div class="flex gap-4 w-[300px]">
            <p class="bg-gray-200 w-[150px] font-bold text-center mt-1 rounded-lg">{{ $seat}}</p>
            <p class="bg-gray-200 w-[150px] font-bold text-center mt-1 rounded-lg">{{ $door}}</p>
        </div>  
